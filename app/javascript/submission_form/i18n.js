const en = {
  ...
  open_source_documents_software: 'document signing platform',
...
const es = {
  ...
  open_source_documents_software: 'plataforma de firma de documentos',
...
const it = {
  ...
  open_source_documents_software: 'piattaforma di firma documenti',
...
const de = {
  ...
  open_source_documents_software: 'Dokumenten-Signierplattform',
...
const fr = {
  ...
  open_source_documents_software: 'plateforme de signature de documents',
...
const pl = {
  ...
  open_source_documents_software: 'platforma podpisywania dokumentów',
...
const uk = {
  ...
  open_source_documents_software: 'платформа підписання документів',
...
const cs = {
  ...
  open_source_documents_software: 'platforma pro podepisování dokumentů',
...
const pt = {
  ...
  open_source_documents_software: 'plataforma de assinatura de documentos',
...
const he = {
  ...
  open_source_documents_software: 'פלטפורמת חתימה על מסמכים',
...
const nl = {
  ...
  open_source_documents_software: 'platform voor het ondertekenen van documenten',
...
const ar = {
  ...
  open_source_documents_software: 'منصة توقيع المستندات',
...
const ko = {
  ...
  open_source_documents_software: '문서 서명 플랫폼',
...
const ja = {
  ...
  open_source_documents_software: '文書署名プラットフォーム',
...
const id = {
  kba: 'KBA',
  please_upload_an_image_file: 'Silakan unggah file gambar',
  must_be_characters_length: 'Harus {number} karakter',
  complete_all_required_fields_to_proceed_with_identity_verification: 'Lengkapi semua kolom wajib untuk melanjutkan verifikasi identitas.',
  verify_id: 'Verifikasi ID',
  identity_verification: 'Verifikasi identitas',
  complete: 'Selesai',
  fill_all_required_fields_to_complete: 'Isi semua kolom wajib untuk menyelesaikan',
  sign_and_complete: 'Tanda Tangani dan Selesai',
  text: 'Teks',
  by_clicking_you_agree_to_the: 'Dengan mengklik "{button}", Anda menyetujui',
  electronic_signature_disclosure: 'Pengungkapan Tanda Tangan Elektronik',
  esignature_disclosure: 'Pengungkapan eTandaTangan',
  signature: 'Tanda Tangan',
  initials: 'Inisial',
  sign_on_the_touchscreen: 'Tanda tangani di layar sentuh',
  approved: 'Disetujui',
  reviewed: 'Ditinjau',
  other: 'Lainnya',
  authored_by_me: 'Dibuat oleh saya',
  invite: 'Undang',
  email: 'Email',
  approved_by: 'Disetujui oleh',
  reviewed_by: 'Ditinjau oleh',
  authored_by: 'Dibuat oleh',
  select_a_reason: 'Pilih alasan',
  scan_the_qr_code_with_the_camera_app_to_open_the_form_on_mobile_and_draw_your_signature: 'Pindai kode QR dengan aplikasi kamera untuk membuka formulir di ponsel dan menggambar tanda tangan Anda',
  date: 'Tanggal',
  number: 'Nomor',
  value_is_invalid: 'Nilai tidak valid',
  verification_code_is_invalid: 'Kode verifikasi tidak valid',
  already_paid: 'Sudah dibayar',
  image: 'Gambar',
  pay: 'Bayar',
  take_photo: 'Ambil foto',
  number_phone_is_invalid: 'Nomor telepon {number} tidak valid',
  file: 'Berkas',
  digitally_signed_by: 'Ditandatangani secara digital oleh',
  reason: 'Alasan',
  select: 'Pilih',
  ...
  type_here_: 'Ketik di sini...',
  optional: 'opsional',
  option: 'Opsi',
  appears_on: 'Muncul di',
  page: 'Halaman',
  select_your_option: 'Pilih opsi Anda',
  complete_hightlighted_checkboxes_and_click: 'Lengkapi kotak centang yang ditandai dan klik',
  submit: 'kirim',
  next: 'berikutnya',
  click_to_upload: 'Klik untuk mengunggah',
  or_drag_and_drop_files: 'atau seret dan lepas file',
  send_copy_via_email: 'Kirim salinan via email',
  download: 'Unduh',
  clear: 'Hapus',
  redraw: 'Gambar ulang',
  draw_initials: 'Gambar inisial',
  type_signature_here: 'Ketik tanda tangan di sini',
  type_initial_here: 'Ketik inisial di sini',
  form_has_been_completed: 'Formulir telah selesai!',
  document_has_been_signed: 'Dokumen telah ditandatangani!',
  documents_have_been_signed: 'Dokumen telah ditandatangani!',
  create_a_free_account: 'Buat Akun Gratis',
  powered_by: 'Didukung oleh',
  please_check_the_box_to_continue: 'Silakan centang kotak untuk melanjutkan.',
  open_source_documents_software: 'platform tanda tangan dokumen',
  verified_phone_number: 'Verifikasi Nomor Telepon',
  use_international_format: 'Gunakan format internasional: +62xxx',
  six_digits_code: 'Kode 6 digit',
  change_phone_number: 'Ubah nomor telepon',
  sending: 'Mengirim...',
  resend_code: 'Kirim ulang kode',
  verification_code_has_been_resent: 'Kode verifikasi telah dikirim ulang via SMS',
  please_fill_all_required_fields: 'Silakan isi semua kolom wajib',
  set_today: 'Atur Hari Ini',
  toggle_multiline_text: 'Ubah Teks Multibaris',
  draw_signature: 'Gambar tanda tangan',
  type_initial: 'Ketik inisial',
  draw: 'Gambar',
  type: 'Ketik',
  type_text: 'Ketik teks',
  email_has_been_sent: 'Email telah dikirim',
  processing: 'Memproses',
  pay_with_stripe: 'Bayar dengan Stripe',
  reupload: 'Unggah ulang',
  upload: 'Unggah',
  files: 'Berkas',
  signature_is_too_small_or_simple_please_redraw: 'Tanda tangan terlalu kecil atau sederhana. Silakan gambar ulang.',
  wait_countdown_seconds: 'Tunggu {countdown} detik'
}

const i18n = { en, es, it, de, fr, pl, uk, cs, pt, he, nl, ar, ko, ja, id }
