...
```java
HttpResponse<String> response = Unirest.get("https://api.sealroute.com/submissions")
...
```java
HttpResponse<String> response = Unirest.get("https://api.sealroute.com/submissions/1001")
  .header("X-Auth-Token", "API_KEY")
  .asString();
```
...
```java
HttpResponse<String> response = Unirest.get("https://api.sealroute.com/submissions/1001/documents")
  .header("X-Auth-Token", "API_KEY")
  .asString();
```
...
```java
HttpResponse<String> response = Unirest.post("https://api.sealroute.com/submissions")
  .header("X-Auth-Token", "API_KEY")
...
```java
HttpResponse<String> response = Unirest.post("https://api.sealroute.com/submissions/pdf")
  .header("X-Auth-Token", "API_KEY")
  .header("content-type", "application/json")
...
```java
HttpResponse<String> response = Unirest.post("https://api.sealroute.com/submissions/docx")
  .header("X-Auth-Token", "API_KEY")
  .header("content-type", "application/json")
...
```java
HttpResponse<String> response = Unirest.post("https://api.sealroute.com/submissions/html")
  .header("X-Auth-Token", "API_KEY")
  .header("content-type", "application/json")
...
```java
HttpResponse<String> response = Unirest.delete("https://api.sealroute.com/submissions/1001")
  .header("X-Auth-Token", "API_KEY")
  .asString();
```
...
```java
HttpResponse<String> response = Unirest.get("https://api.sealroute.com/submitters")
  .header("X-Auth-Token", "API_KEY")
  .asString();
```
...
```java
HttpResponse<String> response = Unirest.get("https://api.sealroute.com/submitters/500001")
  .header("X-Auth-Token", "API_KEY")
  .asString();
```
...
```java
HttpResponse<String> response = Unirest.put("https://api.sealroute.com/submitters/500001")
  .header("X-Auth-Token", "API_KEY")
  .header("content-type", "application/json")
...
```java
HttpResponse<String> response = Unirest.get("https://api.sealroute.com/templates")
  .header("X-Auth-Token", "API_KEY")
  .asString();
```
...
```java
HttpResponse<String> response = Unirest.get("https://api.sealroute.com/templates/1000001")
  .header("X-Auth-Token", "API_KEY")
  .asString();
```
...
```java
HttpResponse<String> response = Unirest.post("https://api.sealroute.com/templates/pdf")
  .header("X-Auth-Token", "API_KEY")
  .header("content-type", "application/json")
...
```java
HttpResponse<String> response = Unirest.post("https://api.sealroute.com/templates/docx")
  .header("X-Auth-Token", "API_KEY")
  .header("content-type", "application/json")
...
```java
HttpResponse<String> response = Unirest.post("https://api.sealroute.com/templates/html")
  .header("X-Auth-Token", "API_KEY")
  .header("content-type", "application/json")
...
```java
HttpResponse<String> response = Unirest.post("https://api.sealroute.com/templates/1000001/clone")
  .header("X-Auth-Token", "API_KEY")
  .header("content-type", "application/json")
...
```java
HttpResponse<String> response = Unirest.post("https://api.sealroute.com/templates/merge")
  .header("X-Auth-Token", "API_KEY")
  .header("content-type", "application/json")
...
```java
HttpResponse<String> response = Unirest.put("https://api.sealroute.com/templates/1000001")
  .header("X-Auth-Token", "API_KEY")
  .header("content-type", "application/json")
...
```java
HttpResponse<String> response = Unirest.put("https://api.sealroute.com/templates/1000001/documents")
  .header("X-Auth-Token", "API_KEY")
  .header("content-type", "application/json")
...
```java
HttpResponse<String> response = Unirest.delete("https://api.sealroute.com/templates/1000001")
  .header("X-Auth-Token", "API_KEY")
  .asString();
```
